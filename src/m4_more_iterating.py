...
def run_test_count_items_bigger_than():
    ...
    # Test 9:
    sequence = [1, 0, 3, 1500, -9000, 392131]
    threshold = -300
    expected = 5
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    # Test 1:
    expected = 2
    actual = count_positive_sines([1, 2, -3, 5, 4, 0, 0])
    print()
    print('Test 1 expected:', expected)
    print('       actual:  ', actual)
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 21
    actual = sum_first_n([6, -10, 25, -5], 3)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 34
    actual = sum_first_n([6, -10, 25, 4, 4, 0, 3, 2, 1], 8)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
